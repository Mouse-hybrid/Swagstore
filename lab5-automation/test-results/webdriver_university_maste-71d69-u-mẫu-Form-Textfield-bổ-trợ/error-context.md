...
- Name: webdriver_university_master.spec.js >> WebDriver University - Module Data Tables & Button States >> TC_TABLE_003 - Nên nhập liệu thành công vào biểu mẫu Form Textfield bổ trợ
- Location: playwright-tests\webdriver_university_master.spec.js:36:5
...
Call log:
  - waiting for locator('textarea.form-control')
